...
if __name__ == '__main__':
    ...
    parser.add_argument('--run_name', default='dit_s', help='The folder name used to save model, output and evaluation metrics. This can be set to any word')
    ...
    parser.add_argument('--batch-size', type=int, default=32, help='The batch size (defaults to 32)')
